...
#include <thrust/host_vector.h>  // thrust::host_vector.h
...
//		std::vector<float2> u2 ;	  // of size staggered_SIZE, or i.e. (L_x+2)*(L_y+2)==(imax+2)*(jmax+2)
		...
		// vector for pressure
		thrust::host_vector<float> p ;	 // of size staggered_SIZE, or i.e. (L_x+2)*(L_y+2)==(imax+2)*(jmax+2)
		thrust::host_vector<float> F, G ; // of size staggered_SIZE, or i.e. (L_x+2)*(L_y+2)==(imax+2)*(jmax+2)
		thrust::host_vector<float> RHS; // of size staggered_SIZE, or i.e. (L_x+2)*(L_y+2)==(imax+2)*(jmax+2)
